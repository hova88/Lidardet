...
from libs.nn import Sequential
...
if __name__ == '__main__':
    ...
    inputs = torch.zeros([1, 128, 496, 432]).cuda()
    rpn = RPN_trt().eval().cuda()
    print(rpn)
    trt = torch2trt(rpn,[inputs],fp16_mode=True,max_workspace_size=1 << 20)
    print('succeed!')
