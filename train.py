        ...
        for _ in range(total_loop):
            ...
            for step in range(steps):
                ...
                try:
                    ...
                    data_iter = iter(dataloader)
                    example = next(data_iter)
                example_torch = example_convert_to_torch(example, float_dtype,device="cuda:0")
            ...
            libs.tools.save_models(eval_checkpoint_dir, [net, optimizer], net.get_global_step(), max_to_keep=100)
